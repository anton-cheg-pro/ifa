  ...
  knowledge: {
    ...
    articles: [
      ...
      },
      {
        ...
        lead: "Що таке фінансова свобода на практиці і з чого почати системну роботу над капіталом.",
      },
      {
        id: "inheritance-broker-account",
        title: "Успадкування активів на брокерському рахунку",
        lead: "Як передаються цінні папери та кошти на рахунку — загальні кроки та ризики.",
      },
      {
        id: "reserve-fund",
      ...
      },
      {
        ...
        lead: "Як оцінити реальну дохідність депозиту в Україні з урахуванням інфляції.",
      },
    ],
  },
  services: {
