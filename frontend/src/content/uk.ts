...
export const pages = {
  ...
  knowledge: {
    ...
    articles: [
      {
        id: "how-to-choose-financial-advisor",
        title: "Як вибрати фінансового консультанта",
        lead: "П'ять типів фінансових радників, моделі оплати та red flags — щоб обрати консультанта свідомо.",
      },
      {
